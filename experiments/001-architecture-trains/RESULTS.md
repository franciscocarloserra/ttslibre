...
- With these settings, alignment did not emerge within the step budget on 185 clips or on 6.6 h multi-speaker. Alignment was first obtained in experiment 002 with a 4-utterance overfit and stronger settings (see `../002-overfit-4-sentences/RESULTS.md`).
