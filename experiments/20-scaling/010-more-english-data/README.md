...
**Short.** English, +54 h (train-clean-100), 2 h run from 006: does more data help held-out and long sentences?
...
**Reading.** Compare the WER table with 006's last rounds (`../../20-scaling/006-generalize-40-speakers/RESULTS.md`). `heldout3` and `knownwords` lower = more data generalizes better. Everything flat = 2 h is not enough to see the effect of the data.
