...
**Iterations.** 1) `mix4h4h` (2026-09-09, aborted at 40 min, in `runs/todelete/mix4h4h_notag`): mistake, text entered with no language marker; every probe still WER > 1 at 40 min, GPU 15–25 % at batch 16. 2) `mix4h4h_tag`: same data and recipe with the tags above.
