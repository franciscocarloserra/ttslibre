...
../panel.py (run from experiments/: ./004-word-generalization/venv/bin/python panel.py)  # http://localhost:7807
```
TensorBoard: see repo AGENTS.md (add `003:experiments/003-single-speaker/runs` to `--logdir_spec`).
